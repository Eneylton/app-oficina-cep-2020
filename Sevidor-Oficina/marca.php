...
if($postjson['crud'] == "listar-marcas"){
        ...
        $query = mysqli_query($mysqli, "SELECT * FROM marca as c ORDER BY c.descricao ASC LIMIT $postjson[start], $postjson[limit]");
    ...
    elseif($postjson['crud'] == "listar-marc"){
        ...
        $query = mysqli_query($mysqli, "SELECT * FROM marca as c ORDER BY c.descricao ASC");
